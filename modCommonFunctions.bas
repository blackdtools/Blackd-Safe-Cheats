...
Public Const ProxyVersion = "38.0" ' Equivalent Blackd Proxy version
Public Const myNumericVersion = 38000 ' Equivalent Blackd Proxy numeric version
Public Const SafeVersion = "2.2.5" ' BSC version
Public Const myNumericSafeVersion = 225 ' BSC numeric version
