...
Public Const ProxyVersion = "35.3" ' Equivalent Blackd Proxy version
Public Const myNumericVersion = 35300 ' Equivalent Blackd Proxy numeric version
Public Const SafeVersion = "2.1.3" ' BSC version
Public Const myNumericSafeVersion = 213 ' BSC numeric version
