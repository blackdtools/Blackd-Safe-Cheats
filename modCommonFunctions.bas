...
Public Const ProxyVersion = "35.6" ' Equivalent Blackd Proxy version
Public Const myNumericVersion = 35600 ' Equivalent Blackd Proxy numeric version
Public Const SafeVersion = "2.1.5" ' BSC version
Public Const myNumericSafeVersion = 215 ' BSC numeric version
