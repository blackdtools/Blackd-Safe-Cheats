...
Public Const ProxyVersion = "42.3" ' Equivalent Blackd Proxy version
Public Const myNumericVersion = 42300 ' Equivalent Blackd Proxy numeric version
Public Const SafeVersion = "2.3.8" ' BSC version
Public Const myNumericSafeVersion = 238 ' BSC numeric version
