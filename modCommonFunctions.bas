...
Public Const ProxyVersion = "37.3" ' Equivalent Blackd Proxy version
Public Const myNumericVersion = 37300 ' Equivalent Blackd Proxy numeric version
Public Const SafeVersion = "2.2.3" ' BSC version
Public Const myNumericSafeVersion = 223 ' BSC numeric version
