...
Public Const ProxyVersion = "40.3" ' Equivalent Blackd Proxy version
Public Const myNumericVersion = 40300 ' Equivalent Blackd Proxy numeric version
Public Const SafeVersion = "2.2.6" ' BSC version
Public Const myNumericSafeVersion = 226 ' BSC numeric version
