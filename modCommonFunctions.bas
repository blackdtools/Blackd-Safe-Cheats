...
Public Const ProxyVersion = "40.4" ' Equivalent Blackd Proxy version
Public Const myNumericVersion = 40400 ' Equivalent Blackd Proxy numeric version
Public Const SafeVersion = "2.2.7" ' BSC version
Public Const myNumericSafeVersion = 227 ' BSC numeric version
