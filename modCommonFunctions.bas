...
Public Const ProxyVersion = "40.9" ' Equivalent Blackd Proxy version
Public Const myNumericVersion = 40900 ' Equivalent Blackd Proxy numeric version
Public Const SafeVersion = "2.3.1" ' BSC version
Public Const myNumericSafeVersion = 231 ' BSC numeric version
