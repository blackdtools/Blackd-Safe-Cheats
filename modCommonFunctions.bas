...
Public Const ProxyVersion = "37.9" ' Equivalent Blackd Proxy version
Public Const myNumericVersion = 37900 ' Equivalent Blackd Proxy numeric version
Public Const SafeVersion = "2.2.4" ' BSC version
Public Const myNumericSafeVersion = 224 ' BSC numeric version
