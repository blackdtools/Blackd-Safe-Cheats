...
Public Const ProxyVersion = "35.4" ' Equivalent Blackd Proxy version
Public Const myNumericVersion = 35400 ' Equivalent Blackd Proxy numeric version
Public Const SafeVersion = "2.1.4" ' BSC version
Public Const myNumericSafeVersion = 214 ' BSC numeric version
