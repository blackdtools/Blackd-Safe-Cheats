...
Public Const ProxyVersion = "40.5" ' Equivalent Blackd Proxy version
Public Const myNumericVersion = 40500 ' Equivalent Blackd Proxy numeric version
Public Const SafeVersion = "2.2.8" ' BSC version
Public Const myNumericSafeVersion = 228 ' BSC numeric version
